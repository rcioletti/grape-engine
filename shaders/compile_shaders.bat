...
C:\VulkanSDK\1.4.321.1\Bin\glslc.exe point_light.vert -o point_light.vert.spv
C:\VulkanSDK\1.4.321.1\Bin\glslc.exe point_light.frag -o point_light.frag.spv
pause