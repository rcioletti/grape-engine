...
namespace vre {
    ...
    VreDevice::VreDevice(VreWindow& window) : window{ window } {
        createInstance();
        setupDebugMessenger();
        createSurface();
        pickPhysicalDevice();
    ...
    void VreDevice::createInstance() {
        ...
        appInfo.pApplicationName = "Vulkan Render Engine App";
    ...
    void VreDevice::createSurface() { window.createWindowSurface(instance, &surface_); }
    ...
    void VreDevice::populateDebugMessengerCreateInfo(
    ...
    VkFormat VreDevice::findSupportedFormat(
